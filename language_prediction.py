...
m = 0 # select data for correlations: 0 - spikes, 1 - activations, 2 - reservoir weights
...
cue1_cor_matrix = correlate_states(results[m], cue1_results[m])
cue2_cor_matrix = correlate_states(results[m], cue2_results[m])
